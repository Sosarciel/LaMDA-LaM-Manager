...
import { buildFIMPrompt, commonFormatResp, commonFormatResult } from "./Utils";


/**DeepSeek FIM 格式化器 */
export const DeepseekFIM: InstructTaskFormatter<OpenAITextRequest, OpenAITextResponse> = {
    /**计算Token数量 */
