...
/**空结果 */
export declare const DefChatLaMResult: TextCompletionResult;
/**文本完成通用结果 */
...
/**文本完成任务通用格式化工具 */
export type TextCompletionTaskFormatter<IOPT, OOPT extends AnyTextCompletionOption, FMT extends AnyTextCompletionRespFormat> = {
...
/**task类型 列表 */
export declare const TaskTypeList: readonly ["chat"];
